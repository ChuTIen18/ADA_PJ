...
### File sở hữu
`backend/app/data/data_generator.py`, `real_loader.py`, `presets.py`, `backend/app/services/simulation_service.py` (đồng sở hữu với A), `test_data_generator.py`, `test_real_loader.py`
